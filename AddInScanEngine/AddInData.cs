...
namespace AddInSpy
{
    public class AddInData
    {
        ...
        internal bool GetVstoAddInData(bool scanManagedInterfaces, bool scanRemote, ref bool isUncPath, ref bool isHttpPath)
        {
            ...
            this.assemblyPath = ConvertFromUri(this.assemblyPath);
        ...
        /// <summary>
        /// Converts the assembly path from uri if necessary.
        /// </summary>
        /// <param name="path">The path.</param>
        /// <returns>A string.</returns>
        private string ConvertFromUri(string path)
        {
            string result = path;
            Uri assemblyUri;
            if (Uri.TryCreate(assemblyPath, UriKind.Absolute, out assemblyUri))
            {
                result = assemblyUri.LocalPath;
            }
